...
Loop **g2** (parent g1). Ledger: 45 records, chain ok.
...
- L0040 retract: Correction: the PySCF researcher never opening the graph was NOT evidence that the graph is not 
- L0041 promote_by_owner: Owner-directed: AGENTS.md and CLAUDE.md take the kernel + topics + graph/loop form; promoted by 
...
- loop components under most pressure: generate(8), evaluators(7), reflect(5), next(5)
