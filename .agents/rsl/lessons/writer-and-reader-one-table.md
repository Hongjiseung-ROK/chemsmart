...
conditions: "PySCF result contracts v4-v5 (2026-09-12/13) and the goal driver's stream records (2026-09-19); synthetic unit tests only, live goals on the ax41 host; a Gaussian preview verifier restating the td grammar its writer owns (R10 Q7, 2026-09-24)"
evidence:
  - "commit:8035bf0c"
  - "commit:f6ce5374"
  - "commit:4b5cf161"
...
supersedes: []
earned: 2026-09-19
last_verified: "2026-09-24 @ cd66bb33"
---
...
Evidence: 8035bf0c (normal-mode units restated in the reader; a selector refused on every real Hessian), f6ce5374 (session_id read as run_id; zero stream rows in four live goals) and 4b5cf161 (a preview verifier restated the td grammar; a TDA preview would have been red).
