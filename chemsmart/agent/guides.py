...
GUIDES: tuple[GuideV1, ...] = (
    ...
    GuideV1(
        ...
        body=(
            ...
            "never read. Five executable stages, one node each: sp, opt, "
            "hess, irc, td. Every quantity belongs to one structure, the final "
            "one: the SCF is re-converged there before anything is read. "
            "supplied_positions is what the run was handed; "
            "reached_positions (opt and irc) is where the walk stopped, "
            ...
            "Not available here: transition-state searches, scans, a ccsd(t) "
