...
def _system_prompt(
    ...
    *,
    ...
    return (
        ...
        "requested observable. Use inspect_workflow_frontier for host-derived "
        "next actions. "
        "When the task names a program, plan that program. If its preview is "
        "refused, repair it from the findings compile_command returns, which "
        ...
        "inspect_program call into environment inspection and project "
        ...
        "plan_scientific_workflow returns findings or a null scientific_workflow_plan, "
