...
| `meoh_b3lyp_d3bj_tzvp_held115.log` | R10 Q30 oracle O1 (2153802), `g_meoh_heldp115` | `opt=modredundant freq`, methanol with H4-C1-O2-H3 held at 115 deg; Gaussian's own check on the held surface converged (maximum internal force 4.33e-4 of 4.5e-4) while the largest Cartesian component left beside the held torsion is 7.5e-4 | `7d17d9ff4c0461f7c09b834d8a4497de4323d0e9c6ae9244722bae09b5e8e5c0` |
| `c2h6_b3lyp_d3bj_tzvp_opt.log` | R10 Q30 oracle O1 (2153802), `g_c2h6_eq` | `opt freq`, ethane staggered: torsion 307.3 cm^-1, CH3 rocks 828.0 and 1223.4, C-C stretch 997.5; converged at a maximum internal force of 3.74e-4 with a largest Cartesian component of 8.1e-4 | `55f92ae74c5081b610a82853cea0e8840e2515cf8048492de254e037da926569` |
