...
def test_every_derivable_thermochemistry_kind_is_named_on_the_field():
    ...
    # The field belongs to the thermochemistry constructor now; the
    # aggregate planner it used to sit on is the finaliser and
    # carries no node schema at all.
    schema = json.dumps(tools["plan_thermochemistry"]["function"])
